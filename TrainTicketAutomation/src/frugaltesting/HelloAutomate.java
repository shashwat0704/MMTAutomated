...
public class HelloAutomate {
	WebDriver driver;

	public void launchBrowser() throws InterruptedException {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\shash\\Downloads\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");
		...
		for (int i = 0; i < length; i++) {
			...
			String element = driver.findElements(By.cssSelector(
					...
					.get(i)
					.getText();
			System.out.println("Enter the city from : " + element);
		...
		for (int i = 0; i < length; i++) {
			...
			String element = driver.findElements(By.cssSelector(
					...
					.get(i)
					.getText();
			System.out.println("Enter the city to : " + element);
			// check if the element is equal to the search term
	...
	public static void main(String[] args) throws InterruptedException {
		HelloAutomate obj = new HelloAutomate();
		obj.launchBrowser();
